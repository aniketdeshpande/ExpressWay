<?php
    ...
    * http://aws.amazon.com
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAIKU7JE6HDBL2NG7A');
    define('AWS_SECRET_ACCESS_KEY', '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');  
...
mysql_connect("www.akshaydhavle.com","akshaydh_eway","expressway") or die("aaaaaa");
?>